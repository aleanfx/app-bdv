...
btnConfirmar.addEventListener('click', () => {
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
            ...
            document.getElementById('r-id').textContent = randNum(8);
            document.getElementById('r-origen').textContent = '0102****' + randNum(4);
            document.getElementById('r-destino').textContent = document.getElementById('c-dest').textContent;
            ...
            document.getElementById('r-title').textContent = document.getElementById('c-title').textContent;
